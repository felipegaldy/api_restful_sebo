package com.sebomaresia.service;
...
import com.sebomaresia.model.UsuarioLogin;
import com.sebomaresia.repository.UsuarioRepository;
...
public class UsuarioService {
	...
	public Optional<UsuarioLogin> autenticarUsuario(Optional<UsuarioLogin> usuarioLogin){
		...
		Optional<Usuario> buscaUsuario = userRepository.findByUsuario(usuarioLogin.get().getUsuario());
